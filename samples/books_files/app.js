...
$j(document).ready(function () {
    ...
    enquire.register('(max-width: ' + bp.medium + 'px)', {
        match: function () {
            $j('.header-content-bottom .store-language-container').prepend($j('.form-language'));
        },
        unmatch: function () {
            $j('.header-content-top .store-language-container').prepend($j('.form-language'));
        }
    });
...
var ProductMediaManager = {
    ...
    wireThumbnails: function() {
        ...
        /*
        * Deactivated because image already changed/swapped when mouse hover the image thumbnail
        * Edi Suryadi - 12 December 2014
